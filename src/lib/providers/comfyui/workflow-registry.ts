...
export const COMFYUI_DEFAULT_VIDEO_WORKFLOW_ID = COMFYUI_MINIMAX_H3_I2VA_WORKFLOW_ID
...
const OPTIONAL_MODEL_BYPASS_NODE_TYPES = new Set<string>()
...
export function resolveComfyUiWorkflow(
  ...
  const imageFilenames = inject.imageFilenames
  if (isMiniMaxH3Workflow) {
